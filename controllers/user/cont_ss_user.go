...
// @Router /api.v1/capster/user/{id} [get]
...
// @Router /api.v1/capster/user [get]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/user [post]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/user/{id} [put]
...
// @Param id path string true "ID"
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/user/{id} [delete]
