...
func NewContAuth(e *echo.Echo, useAuth iauth.Usecase) {
	...
	// e.POST("/api.v1/capster/auth/register", cont.Register)
	e.GET("/swagger/*", echoSwagger.WrapHandler)
	e.GET("/health_check", cont.Health)
	r := e.Group("/api.v1/capster/auth")
...
// @Router /api.v1/capster/auth/login [post]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/auth/change_password [post]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/auth/register [post]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/auth/verify [post]
...
// @Success 200 {object} tool.ResponseModel
// @Router /api.v1/capster/auth/forgot [post]
